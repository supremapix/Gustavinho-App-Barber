    ...
    <div className="w-full pt-28 pb-16 bg-[#0f0f0f]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <p className="text-sm sm:text-base text-[#a1a1aa] max-w-xl leading-relaxed">
          Localização privilegiada na Rua Desembargador Cid Campelo, 5212 no bairro CIC em Curitiba - PR.
        </p>
      </div>
          ...
          <div className="lg:col-span-5 bg-[#18181b] border border-[#27272a] p-6 sm:p-8 rounded-2xl flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="border-t border-[#27272a] pt-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-extrabold text-base text-white">Segunda a Sábado</h3>
                    <p className="text-sm text-[#d4af37] font-semibold">09:00 às 19:00</p>
            ...
            <div className="grid grid-cols-2 gap-3 mt-8 pt-6 border-t border-[#27272a]">
              <a
                ...
                className="p-3.5 rounded-xl bg-[#d4af37] text-[#0f0f0f] hover:bg-[#e5c158] text-xs font-black flex items-center justify-center gap-2 active:scale-95 transition-all min-h-[48px]"
              >
